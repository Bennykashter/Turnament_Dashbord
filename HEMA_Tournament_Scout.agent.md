...
4. SOURCING: Combine upcoming official fixtures tracked via https://hemaratings.com/ with prominent annual circuit mainstays or club-run tournaments that repeat every year. Extend research to the following sources in order:
   ...
   - Facebook: Search Facebook Events (facebook.com/events) for "HEMA tournament 2026 Europe" and per-country variants ("HEMA tournament Italy 2026", "HEMA tournament Poland 2026", etc.). Also search Facebook Groups — the main ones are "HEMA Events", "HEMA Worldwide", and country-specific groups like "UK HEMA", "Polish HEMA", "Italian HEMA Tornei". Many smaller or newer tournaments announce exclusively on Facebook before appearing on any aggregator.
   - Instagram: Search hashtags #HEMAtournament #HEMAevent #HEMA2026 and check organizer accounts for event announcements
